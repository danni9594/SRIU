...
train_config = {'method': 'spmf',
                'dir_name': 'soba_MF_SPMF_19-30',  # edit based on dataset, model, method, period range
        ...
        for lr in [1e-2]:
            ...
            for dropout_prob in [1]:
                ...
                for period in range(train_config['start_period'], train_config['end_period'] + 1, train_config['period_length']):
                    ...
                    train_config['model_alias'] = 'MF_SPMF_' + str(period)
                    ...
                    if period == train_config['start_period']:
                        ...
                        prev_model_alias = 'MF_SPMF_' + str(period - train_config['period_length'])
