...
train_config = {'method': 'full_retraining',
                'dir_name': 'soba_MF_FR_19-30',  # edit based on dataset, model, method, period range
                'pretrained_model': 'soba_MF_pretrained_1-18_0.001',  # edit pretrained model
                'start_period': 19,  # overall train start period
                'end_period': 30,  # overall train end period
                'period_length': 1,
...
for lr in [1e-2]:
    ...
    for period in range(train_config['start_period'], train_config['end_period'] + 1, train_config['period_length']):
        ...
        train_config['train_start_period'] = 1
        ...
        train_config['model_alias'] = 'MF_FR_' + str(period)
        ...
        if period == train_config['start_period']:
            ...
            prev_model_alias = 'MF_FR_' + str(period - train_config['period_length'])
