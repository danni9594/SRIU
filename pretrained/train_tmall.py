...
pretrained_config = {'method': 'pretrained',
                     'train_start_period': 20141001,
                     'train_end_period': 20141018,
                     'test_start_period': 20141019,
                     'test_end_period': 20141019,
                     'model_alias': 'tmall_MF_pretrained_10.01-10.18',  # edit based on dataset, model, method, period range
